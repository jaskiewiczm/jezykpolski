...
export default class IndividualKlass extends React.Component {
  ...
  render() {
    var editContent = this.state.editMode ? <KlassEditor klass={this.props.klass} schoolId={this.props.schoolId} klassId={this.state.klassId} name={this.state.name} callback={this.editClosed} /> : null
