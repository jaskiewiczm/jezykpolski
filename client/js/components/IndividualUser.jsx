...
export default class IndividualUser extends React.Component {
  ...
  render() {
    var editContent = this.state.editMode ? <UserEditor user={this.props.user} masterUsers={this.props.masterUsers} userId={this.state.userId} name={this.state.name} email={this.state.email} schoolId={this.state.schoolId} callback={this.editClosed} userRoles={this.state.userRoles}/> : null
    var individualUserId = 'individual_user_' + String(this.state.userId)
